...
| 38 | source-exec-314-mwbe-cert-validity.md | load-bearing-passage check vs NY Open Legislation §314(5)(a); dual-model (GPT-5 High + Perplexity, blind) + human primary-source confirmation; capture-fidelity re-check 2026-07-03 | **PASS** — the verbatim five-year MWBE validity sentence, CURRENT §314(5)(a) text (with the §310(23) provisional-cert exception), replacing the expired "5." version; cite()-checked. Capture corrected 2026-07-03 to include the State's statutory markers ("** NB Effective July 1, 2026", "* NB Repealed July 1, 2028") originally dropped. Sunset-watch: Art. 15-A authorization expires 2028-07-01 — **primary-verified 2026-07-03** against the "* NB Repealed July 1, 2028" note on nysenate.gov §314 (repeal covers all of Art. 15-A, §§310–318) |
