# SOURCE TEXT — NY State Finance Law § 179-f (Determination of eligibility for payment of interest on amounts owed to contractors)

- **Name:** State Finance Law § 179-f — Determination of eligibility for payment of interest on amounts owed to contractors (Article 11-A, Interest Payments On Certain Amounts Owed By State)
- **Date:** Current revision as of 2017-04-14 (the version shown by NY Open Legislation on the capture)
...
> (e.g. "seventy-nine-g", "back-up"); those have been rejoined to the statute's true spelling — no
> word, comma, or number altered. Nothing here is reworded. nysenate.gov's bot-detection blocked the
> direct fetch of this one page, so this primary-source PDF is the capture of record. Re-open the
> link to confirm the 2017-04-14 revision before production reliance — and note the active-legislation
> freshness flag (S7001 / S4877 propose changes to this section).
...
- NY State Finance Law § 179-g (computation of interest payment; the $10 de-minimis test) — subd. 1
- NY Highway Law § 38(8) (final payments on highway construction contracts) — subd. 2(g)
- NY Public Service Law and tariffs thereunder (public-utility invoices) — subd. 4
- Key figures: required payment date 30 days general / 15 days small business / 75 days final highway construction; agency defect-notice window 15 days general / 7 days small business; $10 interest de-minimis; "small business" = ≤200 employees
