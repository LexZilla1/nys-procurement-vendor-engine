# SOURCE TEXT — NY State Finance Law § 179-v (Interest payments — Article 11-B)

- **Name:** State Finance Law § 179-v — Interest payments (Article 11-B, Prompt Contracting)
...
- **Link (permanent identifier):** https://www.nysenate.gov/legislation/laws/STF/179-V
...
> (pasted raw, then diff-verified). Nothing here is reworded. This is the NFP prompt-contracting
> INTEREST section — the statutory authority behind the six-part interest test in GFO XI.4.A.
> ⚠ Active bill S7001 (2025-2026) targets this section hardest: it proposes REPEALING subdivision 7
> (removing the interest-waiver ability), requiring all interest be paid in full with the first
> payment, and setting interest at the current PRIME rate. None enacted as of capture; the text below
> is the current 2014-09-22 version (waiver still allowed; rate = Tax Law §1096(e)(1) corporate
> overpayment rate). High freshness priority — re-open the link to confirm before production reliance.
...
- NY Tax Law § 1096(e)(1) — corporate-tax rate set by the Commissioner of Taxation and Finance; the NFP interest rate (subd. 2). NOTE: §179-v says "for corporate taxes... paragraph one of subsection (e)"; GFO XI.4.A / XII.6.C describe it as the "overpayment" rate. Both point to §1096(e).
- NY State Finance Law § 179-u (advance payments; interest interplay — subd. 1(b), 5)
- NY State Finance Law § 179-s and § 179-t (the timeframes whose being-met is documented for a waiver — subd. 7(a))
- "scheduled commencement date," "written directive," "fully executed contract" — defined in § 179-q
- Not-for-profit short-term revolving loan fund (subd. 1(b))
- Key mechanics: interest runs from scheduled commencement date or services-start (whichever later) to payment date (subd. 1(a)); paid from STATE OPERATIONS / administrative appropriations, NEVER from program appropriations (subd. 3); interest does not reduce the contract amount (subd. 4); no interest if AG/Comptroller DISAPPROVE the contract (subd. 6) — the structural "clock never starts" confirmation; 20-day Comptroller waiver determination + 30-day voucher-or-assess (subd. 7(b))
- ⚠ Pending amendment: S7001 (repeal subd. 7 waiver; pay interest with first payment; rate = prime)
