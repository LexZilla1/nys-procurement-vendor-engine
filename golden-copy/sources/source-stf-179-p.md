# SOURCE TEXT — NY State Finance Law § 179-p (Inapplicability of the provisions)

- **Name:** State Finance Law § 179-p — Inapplicability of the provisions (Article 11-A, Interest Payments On Certain Amounts Owed By State)
- **Date:** Current revision as of 2014-09-22 (NY Open Legislation)
...
> and payee categories to which Article 11-A prompt-payment interest does NOT apply; it is the
> statutory basis for the RM-2 interest-calculator exclusion pre-screen. The set-off in clause 6 is
> defined at SFL § 179-e(8) (see source-stf-179-e.md). Nothing here is reworded.
...
- Eminent Domain Procedure Law (EDPL) — payments under it are excluded (clause 1)
- Court-rendered judgment interest under any provision of law other than Article 11-A (clause 2)
- Social Services Law § 367-b — the fiscal agent / fiscal intermediary example of an excluded
  third-party payment agreement contractor (clause 4)
- SFL § 179-e(8) — defines "Set-off" (the reduction by the comptroller of a payment due to a
  contractor by an amount equal to an unpaid legally enforceable debt) referenced by clause 6
- Cross-reference: SFL § 179-f $10 de minimis floor — a distinct eligibility screen from these
  inapplicability exclusions (no interest if the computed amount is less than ten dollars)
