# SOURCE TEXT — NY State Finance Law § 179-d (Legislative intent)

- **Name:** State Finance Law § 179-d — Legislative intent (Article 11-A, Interest Payments On Certain Amounts Owed By State)
...
- **Link (permanent identifier):** https://www.nysenate.gov/legislation/laws/STF/179-D
...
- (None — this is the legislative-intent preamble for Article 11-A, the vendor Prompt Payment regime.)
