# SOURCE TEXT — GFO XII.4.F Proper Invoice

<!-- ============================================================
     THE FOUR LABELS (metadata — this is ABOUT the text, not the text)
     ============================================================ -->

- **Name:** XII.4.F Proper Invoice
- **Date:** REV. 03/10/2020 (page last modified 06/05/2026)
...
> them. Before relying on this in production, re-open the link above and confirm the text and the
> REV. date still match — if the State changes the page, this file must be re-copied.
...
These are the other laws the State text refers to, listed so they can be traced later. Listing
them does not change the text above.

- NYS State Finance Law § 109(1)
- NYS State Finance Law § 179-e(5)
- NYS State Finance Law § 179-f(3)(b)
- GFO XII.5.B — Unique Invoice Number Requirements (same chapter)
- GFO XII.4.B.1 — Supporting Information (same chapter)
- OSC Invoice Checklist (PDF): https://www.osc.ny.gov/files/state-agencies/pdf/xii-4-f-att.pdf
