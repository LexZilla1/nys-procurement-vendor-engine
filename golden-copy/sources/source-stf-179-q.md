# SOURCE TEXT — NY State Finance Law § 179-q (Definitions — Article 11-B)

- **Name:** State Finance Law § 179-q — Definitions (Article 11-B, Prompt Contracting and Interest Payments for Not-for-Profit Organizations)
...
> propose amending the §179-q definitions (e.g. "renewal contract," "written directive," adding
> "registered contract"); none enacted as of capture — the text below is the current 2014-09-22
> version. Re-open the link to confirm before production reliance.
...
- NY State Finance Law § 49 (certificate of approval / director of the budget authorization) — def. 3
- NY Not-for-Profit Corporation Law (definition of "not-for-profit organization") — def. 7
- US Internal Revenue Code § 501(c)(3) (tax-exempt status) — def. 7
- Special-act corporation references: L.1899 ch. 468; L.1917 ch. 256; Act of Congress approved Jan. 5, 1905 (33 Stat. 599) — def. 7
- Key defined terms that the rest of Article 11-B and GFO XI.4.A rely on: "fully-executed contract" (def. 4 — note it requires OSC approval + filing, the structural gate), "written directive" (def. 14 — the work-at-risk instrument), "renewal contract" (def. 9), "program plan" (def. 6), "scheduled commencement date" (def. 12)
