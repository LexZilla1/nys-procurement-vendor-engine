# SOURCE TEXT — MWBE Pass/Fail Provisions (5 NYCRR Parts 140–145)

- **Name:** Participation by Certified Minority and Women-Owned Business Enterprises on State Contracts — pass/fail provisions of 5 NYCRR Parts 140–145 (Title 5, Chapter XIV, Division of Minority and Women's Business Development)
- **Date:** Regulation text as published by ESD (compilation dated 12/02/2020 on the PDF); load-bearing provisions confirmed against the live NYCRR (updated quarterly) on 2026-06-29
- **Issued by:** NY State Department of Economic Development, Division of Minority and Women's Business Development (ESD/DMWBD); promulgated under NY Executive Law Article 15-A
- **Link (primary, ESD-published full regulation PDF):** https://esd.ny.gov/sites/default/files/MWBERegulations-120220.pdf
...
> Subtitle runs ~50 pages; Part 141 (agency master-goal-plan administration), Part 144 (the
> certification application/revocation process — i.e., how a firm BECOMES an MWBE), and Part 145
> (appeals/hearings) govern agency/division conduct or certification, not vendor document validation,
> and are intentionally out of scope (same rationale as the §179 out-of-scope note in Domain 4).
>
> **Verification.** Captured from the official ESD-published regulation PDF (fetched and text-extracted
> from the primary link above), then the load-bearing provisions were independently cross-checked
> against the live, quarterly-updated NYCRR via Cornell LII — §142.6 (deadline cascade), §142.4
> (required fields), §142.7, §142.12, and §140.1(kk) thresholds all matched verbatim. Verified by
> **load-bearing-passage check**, not a full 50-page clause-by-clause diff (only the pass/fail subset
> is reproduced). Capture-date + freshness-flag convention applies: the NYCRR can be amended; re-pull
> before production reliance.
>
> ⚠ **MUST/SHOULD note.** The hard rejection triggers here read in mandatory terms: a deficient/late
> utilization plan or waiver form "may be grounds for disqualification for non-responsiveness"
> (§142.6(f)-(g)); failure to submit an EEO policy statement/staffing plan "shall result in the
> rejection of the contractor's bid or proposal" (§143.3(c)). Treat these as hard-block items in any
> validation engine.
...
SOURCE: 5 NYCRR Parts 140–145 (Title 5, Chapter XIV, Division of Minority and Women's Business Development) — the MWBE participation regulations promulgated under NY Executive Law Article 15-A. This file captures ONLY the pass/fail provisions a bidding/contracting vendor must satisfy. The full Subtitle also covers agency master-goal-plan administration (Part 141), the certification application/revocation process (Part 144), and appeals/hearings (Part 145), which govern agency and division conduct or how a firm BECOMES certified — out of scope for vendor document validation and intentionally not reproduced here.

================================================================
§ 140.1(f) — COMMERCIALLY USEFUL FUNCTION (the anti-pass-through rule)
================================================================
...
================================================================
§ 140.1(kk) — STATE CONTRACT (the dollar thresholds that trigger the whole regime)
================================================================
...
(5) a written agreement whereby a State agency purchases, sells, leases, acquires or grants an interest in real property and where the terms of such agreement provide for a party to such agreement to (i) perform construction, construction-related services, or services necessary to complete the transfer of interest in real property, or (ii) purchase a commodity related to the activities set forth in subsection (5)(i);
...
[§ 142.4(f):] Proceeds from State contracts that are paid to certified minority and women-owned business enterprises that are not performing commercially useful functions shall be disregarded by State agencies for utilization purposes.

================================================================
§ 142.6 — SUBMISSION AND REVIEW OF UTILIZATION PLANS (the deadline cascade)
================================================================
(a) In the case of a request for proposals, request for qualifications, or negotiated State contracts, for which contract goals have been set, the time for submitting the utilization plan shall be upon submission of any proposal, qualifications, or negotiated contract. The State agency may waive or modify this requirement by sending a written notice to the director with an explanation ten (10) days before solicitations are issued.
(b) In the case of any bid submission, utilization plans shall be submitted after the opening of bids, but in no case more than ten (10) business days after the contractor receives notice from a State agency that the contractor has submitted a low bid, provided the agency may adopt a longer time period for submission of utilization plans as to all or particular categories of its contracts upon filing of such period and any supporting justification with the director, and subject to rejection or modification by the director. Any such modification or rejection shall apply to contract solicitations on or after the date of the rejection or modification.
(c) The State agency shall review a utilization plan submitted by a contractor and issue a written notice of acceptance or deficiency regarding the utilization plan no later than twenty (20) days after receipt of the utilization plan, and prior to the execution of the contract resulting from said procurement. A State agency may accept a utilization plan if:
...
(4) the contractor submits a mentor-protege agreement acceptable to the agency, which does not meet the goals set forth in the solicitation, but reflects an investment by the mentor in the protege roughly equal to the difference between the contract goals set forth in the solicitation and the percentage of value added participation provided by the protege.
...
(e) Unless otherwise specified in the information, instructions or requirements and any addenda provided to contractors for purposes of soliciting bids or proposals, a contractor must provide a State agency with a written remedy in response to a notice of deficiency within seven (7) business days of its receipt.
(f) If the contractor's written remedy to a notice of deficiency is not timely provided or if the written notice is found by the State agency to be inadequate such a failure to remedy the deficiency may be grounds for disqualification for non-responsiveness or the State agency may notify the contractor and request the contractor to submit a waiver form within five (5) business days. Failure to file the waiver form in a timely manner may be grounds for disqualification of the bid for non-responsiveness.
(g) Failure of the contractor to comply with the requirements of section 142.6(e) may result in the disqualification of the contractor under this Part.
...
================================================================
§ 142.7(a) and (d) — WAIVERS (no automatic waiver; the waiver-form information list)
================================================================
(a) A State agency shall not grant any automatic waivers of goal requirements on a State contract but may grant a partial or total waiver of goal requirements established on a State contract only upon the submission of a waiver form by a contractor, documenting good faith efforts, as defined in Section 142.8, by the contractor to meet the goal requirements of the State contract, and in consideration of the following factors:
...
(9) Whether the contractor provided timely written notification of subcontracting opportunities on the State contract to appropriate certified businesses that appear in the directory of certified businesses prepared pursuant to paragraph (f) of subdivision three of section 311 of the Executive Law; and
...
================================================================
§ 142.8(a) — CONTRACTOR'S GOOD FAITH EFFORTS (the minimum documentation list)
================================================================
...
================================================================
§ 142.9(a) — CONTRACTOR DISQUALIFICATION (proceeding to the next bidder)
================================================================
...
(1) twelve (12) days after sending a written notice of deficiency, as specified in section 142.6 of this Part, to the contractor, and the State agency has not received a request for an administrative hearing from the contractor,
...
(3) after receiving a written notification of a resolution from the director, or a decision of the division's hearing officer.

================================================================
§ 142.13(b) — DEBARMENT (the consequence of fraudulent/willful violation)
================================================================
...
================================================================
§ 143.3(c) — EEO POLICY STATEMENT / STAFFING PLAN (the EEO rejection trigger)
================================================================
...
[Companion, § 143.2(d)(4) — what the staffing plan is:] Except for construction contracts, prior to an award of a State contract, the contractor may be required to submit to the contracting agency a staffing plan of the anticipated work force to be utilized on the State contract or, where required, information on the contractor's total work force, including apprentices, broken down by specified ethnic background, gender, and federal occupational categories or other appropriate categories specified by the contracting agency. The form of the staffing plan shall be supplied by the contracting agency.

---

## AGENCY GUIDANCE LAYERED ON TOP OF THE REGULATION (NOT regulation text — do not treat as verbatim rule)

These two figures are widely applied by vendors but are **NOT** stated in 5 NYCRR Parts 140–145. They
are agency/program guidance built on the regulation, captured here only to mark the distinction so the
golden copy never misattributes them to the regulation:

- **The "30% / 15% / 15%" goal split** — multiple agencies (e.g., OGS) publish a *default* agency-wide
  goal of 30% total MWBE participation (15% MBE / 15% WBE). The regulation itself sets NO statewide
  percentage; §142.2 has each agency set the goal **per contract**. The binding number for any given
  procurement is whatever that solicitation states. → belongs in the per-solicitation layer, not here.
- **The 60% supplier credit "haircut"** — ESD guidance provides that NYS-certified MWBEs coded as
  construction *suppliers* receive credit for only 60% of payments toward the goal. The regulation's
  basis for this is the **commercially-useful-function** rule (§140.1(f), captured verbatim above);
...
- 5 NYCRR §140.1 — definitions (commercially useful function (f); State contract thresholds (kk); subcontract (ll); small business (hh); minority group member (aa); MBE/WBE (bb)/(uu))
- 5 NYCRR §142.2 — agency establishes contract goals per contract (why no fixed statewide %)
- 5 NYCRR §142.3 — diversity-practices scoring (best-value RFPs ≥ $250,000)
- 5 NYCRR §142.4, §142.6, §142.7, §142.8, §142.9, §142.13 — utilization plan, review cascade, waivers, good-faith efforts, disqualification, debarment
- 5 NYCRR §143.2–§143.3 — EEO policy statement + staffing plan / work force utilization report
- NYS Directory of Certified MWBEs / NYS Contract System (NYSCS): https://ny.newnycontracts.com — the authoritative "is this firm certified?" check
- Cross-refs within this golden copy: source-xi-18-a-mwbe.md (GFO XI.18.A overview), source-sdvob.md (parallel SDVOB program, Exec. Law Art. 17-B), source-stf-163.md (§163(6) $1.5M MWBE discretionary threshold — independently confirmed consistent)
- Companion separate capture (if needed later): ESD Office of Contractor and Supplier Diversity guidance (the 60% supplier credit; the 30/15/15 default)
