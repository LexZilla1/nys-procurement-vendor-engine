# SOURCE TEXT — GFO XII.4.B.1 Supporting Information
...
> path "gfochapter-xii" — these are reproduced EXACTLY as they appear on the State's page and are the
> State's, not transcription errors. Nothing here is reworded. Before relying on this in production,
> re-open the link above and confirm the text and the REV. date still match.
...
Title 2, Chapter I, Part 6.5 of the New York Codes, Rules and Regulations (NYCRR) requires agencies to certify to the Comptroller that claims for payment are just, true and correct and therefore appropriate to pay. In addition, Title 2, Chapter I, Part 6.7 of the NYCRR requires agencies to support any claim for payment entered in to the Statewide Financial System (SFS) with sufficient original source documentation including, but not limited to, a vendor invoice or a vendor claim and a receiving report.

As part of these requirements, the agency certifier should be satisfied that acceptable information or documentation is on file to (i) show goods and/or services provided by the vendor are in accordance with the terms and conditions of the agreement, or (ii) verify employee expenses are in accordance with New York State's travel rules and regulations, union contracts, and/or agency policies. Agencies are required to retain all original source documentation and other agency records in support of financial transactions to ensure it is readily available to agency management, the Office of the State Comptroller and other interested parties. For information on record retention and storing documents in support of transactions in the SFS, please refer *to* *Section 3 – Record Retention – Accounts Payable Vouchers and Land Claims* *of this Chapter and* *Chapter XIV, Section 9 – Statewide Financial System Imaging and Attachment Guidance* of this Guide.

Agencies certify millions of dollars in claims for payment daily. It is critical for accounts payable staff to practice good stewardship over State money when making the final approval on claims for payment submitted to the Comptroller. This includes cases where accounts payable staff seek initial approval of (1) claims or invoices from agency program staff or (2) expense reports from employees' supervisors.

All staff responsible for providing an initial or final approval of claims, invoices or expense reports, whether they are in the finance office or in a program area, should have a clear understanding of their responsibilities and have tools necessary to aid in their validation. To ensure all affected staff are aware of their responsibilities to validate claims, invoices or expense reports, agency management should incorporate these responsibilities in staffs' performance expectations. Agency management should also provide affected staff with tools, such as those in this section, to aid in validating claims, invoices or expense reports.

These actions, if carried out effectively, can provide a reasonable basis for agency staff to certify claims to the Comptroller. It can also help provide a reasonable basis for the head of an agency to certify internal controls over the payment process, as required by Title 2, Chapter I, Part 6.6 of the NYCRRand described in *Section 4.D - Certification of Internal Controls over the Payment Process* of this Chapter.
...
- Overhead Costs
- Property Leases
- Advance Account Reimbursements
- Advance Payments
...
Agencies should resolve situations where the supporting information does not substantiate the claims for payment. This may include rejecting them back to the vendor or employee to correct or adjusting the claims. In cases where the agency suspects the vendor or State employee has committed fraud, the agency should refer the evidence to their Inspector General and to the Office of the State Comptroller, consistent with *Section XII.10.E - Reporting the Theft, Loss or Misuse of State Assets* of this Chapter.

**Where to Obtain Supporting Information**

The vendor will most likely provide the agency with an invoice or a completed claim for payment form for the goods and/or services provided. The agency should obtain enough information to provide assurance that the vendor delivered the goods and/or services as expected. Generally, the accounts payable staff should obtain a requisition and/or purchase order, an invoice or claim for payment, and confirmation that the agency received the goods and/or services.

Accounts payable staff should analyze this information or documentation to determine whether the vendor provided the correct good or service at the right price. If accounts payable staff rely on end users to confirm an invoice is appropriate to pay, accounts payable staff should ensure the end users obtain and verify supporting information before asserting that the invoice or claim for payment is appropriate. For example, on a risk basis, accounts payable staff can contact end users prior to making a payment to understand how they confirmed the invoice was appropriate to pay.
...
Agency staff should communicate to vendors those factors that can facilitate timely payments. This includes advising the vendor to retain sufficient support for charges on invoices and include only allowable costs on invoices. Agencies should communicate to vendors the requirements outlined in *Appendix A – Standard Clauses for All New York State Contracts* and in *Section 4.F – Proper Invoice* of this Chapter.
...
- 2 NYCRR Title 2, Chapter I, Part 6.5 (certify claims just, true and correct)
- 2 NYCRR Title 2, Chapter I, Part 6.6 (internal controls certification)
- 2 NYCRR Title 2, Chapter I, Part 6.7 (original source documentation requirement)
- GFO XII.3 — Record Retention – Accounts Payable Vouchers and Land Claims
- GFO XII.4.D — Certification of Internal Controls over the Payment Process
- GFO XII.4.F — Proper Invoice
- GFO XII.10.E — Reporting the Theft, Loss or Misuse of State Assets
- GFO XIV.9 — Statewide Financial System Imaging and Attachment Guidance
- GFO XI.11.F — Contract Monitoring (and its Exhibit B)
- Appendix A — Standard Clauses for All New York State Contracts: https://ogs.ny.gov/procurement/appendix
- State Travel Manual: https://www.osc.ny.gov/files/state-agencies/travel/pdf/agencies-travel-manual-attachment.pdf
- Supporting-information attachment PDFs (Goods, Services, Pre-paid Expenses, Utilities, Overhead Costs, Property Leases, Advance Account Reimbursements, Advance Payments, Performance Milestones, Travel Expenses, Employee Non-Travel Expenses) — linked from the page
