# SOURCE TEXT — GFO XII.5.I Prompt Payment Interest
...
> Payment Interest Calculations"); both are reproduced in full below under their own headings.
...
- NYS State Finance Law §179-f (Prompt Payment; 30-day / 15-day-small-business / 75-day-highway windows; $10 de-minimis)
- NYS State Finance Law §179-p (payment types/entities not entitled to prompt payment interest)
- NYS Social Services Law §367-b (third-party payment agreement contractors)
- GFO Chapter XIV, Section 13.A – Prompt Payment Interest Overview
- GFO Chapter X, Section 4.A – Vendor Certifications
- GFO Chapter III, Section 9 – Provisions for 15 Day Prompt Payment Interest Eligibility
- GFO Chapter XII, Section 5.F – Adjusting the MIR Date
- GFO Chapter IV – Accounting Codes, Uses and Descriptions
- Account codes: 58401 Prompt Payment Interest; 60311 Interest – Grants to Others; 60740 Interest on Late Payments – Capital Projects
- Prompt Payment Interest Calculator: https://www.osc.ny.gov/files/state-agencies/excel/xii-5-l-att.xlsx
```
