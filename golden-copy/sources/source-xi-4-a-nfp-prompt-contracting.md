# SOURCE TEXT — GFO XI.4.A Not-for-Profit Prompt Contracting
...
- **Link (permanent identifier):** https://www.osc.ny.gov/state-agencies/gfo/chapter-xi/xi4a-not-profit-prompt-contracting
- **Copied exactly on:** 2026-06-28
- **Covers:** OSC GFO section — full page (manual capture)

> Everything below the line is the State's own text, copied word-for-word, including the full
> time-frame table, the six-part interest test, and all six worked examples. Nothing here is
...
| RENEWAL CONTRACTS | | |
| RESPONSIBILITY | REQUIREMENTS | TIME FRAMES |
| State Agency | If a State agency intends to renew a contract, notify the NFP by issuing either a letter of the State agency's intent to renew or the renewal contract documents with a dated cover letter.  If the State agency's intent is to terminate the contract, notify the NFP in writing of intent and provide the reasons. | Not later than 90 days prior to the end of the contract, or any periods specified within the contract that require further contract documents in order to continue contract payments, or 30 days after enactment of appropriation providing funding for continued payments, whichever is later. |
| State Agency | Upon notifying the NFP of its intention to execute a renewal contract, the State agency shall negotiate contract terms and shall issue a written directive to the NFP.  Submit renewal contracts to the Attorney General (to be forwarded directly to the Comptroller after approval).  Submit renewal contracts consisting of simplified contract documents directly to the Comptroller. | Immediately    No later than 60 days prior to the start of the renewal contract.    No later than 60 days prior to the start of the renewal contract. |
| Office of the Attorney General (OAG) | Approve new or renewal contracts and forward to the Comptroller or non-approve and return to the agency with the reason(s). | Within 15 days of receipt of a new or renewal contract. |
...
¹ See Chapter XI, Section 15A – Competitive Grants Procurement Record, for additional information.
² Ibid.
...
³ See 2 CRR-NY 22.5(a)(ii) PROMPT CONTRACTING AND INTEREST PAYMENTS FOR NOT-FOR-PROFIT ORGANIZATIONS.
...
- NYS State Finance Law Article XI-B (The Prompt Contracting Law); Ch. 166 of 1991, amended by Ch. 648 of 1992 and Ch. 292 of 2007
- NYS State Finance Law Article XI-A (Prompt Payment Law)
- NYS State Finance Law Section 179-t(1) and 179-t(2) (renewal/termination notice)
- 2 NYCRR Part 22 / 2 CRR-NY 22.5(a)(ii) (Prompt Contracting and Interest Payments for NFP Organizations)
- GFO XI.2.A — Thresholds
- GFO XI.4.B — Standard Contract Language for Grant Contracts
- GFO XI.4.E — Not-for-Profit Short-Term Loan Fund
- GFO XI.15.A — Competitive Grants Procurement Record
- GFO XII.5.I — Merchandise/Invoice Received Dates and Prompt Payment Interest Calculations
- GFO XII.6.C — Paying Prompt Contract Interest (SFS interest code 58403)
- DOB Budget Bulletin H-1032 (Master Grant Contract requirement)
- Forms: Attachment A/B/C/D Written Directives & Waiver of Interest; Late Contract Interest Worksheet; STS / AC 340-S; AC 3308-S
