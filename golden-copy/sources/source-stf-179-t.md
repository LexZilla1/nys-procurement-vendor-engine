# SOURCE TEXT — NY State Finance Law § 179-t (Time frames for the execution of renewal contracts)

- **Name:** State Finance Law § 179-t — Time frames for the execution of renewal contracts (Article 11-B, Prompt Contracting)
...
- **Link (permanent identifier):** https://www.nysenate.gov/legislation/laws/STF/179-T
...
> (pasted raw, then diff-verified). Nothing here is reworded. NOTE: §179-t governs RENEWAL-contract
> time frames (not the interest formula — that is §179-v). ⚠ Active bill S4877 (2025-2026) proposes
> amendments touching §179-t (agency-noncompliance reporting). None enacted as of capture; the text
> below is the current 2014-09-22 version. Re-open the link to confirm before production reliance.
...
- NY State Finance Law § 179-v (payment of interest; subd. 1(c) directs the interest voucher there)
- "renewal contract," "written directive," "simplified contract documents" — defined in § 179-q
- Key time frames: 90-day preliminary intent-to-renew-or-terminate notice (subd. 1(a)); 30-day-after-budget alternative; 20-day Comptroller "unusual circumstances" interest-denial determination (subd. 1(c)); 60-day AG/Comptroller renewal-contract submission with 15-day approval windows (subd. 4)
- "Deemed to continue" rule: if the agency fails to give required non-renewal notice, the contract continues in effect and extension expenses remain reimbursable (subd. 2)
- "Unusual circumstances" exclusions (subd. 1(b)): does NOT include failure to plan/staff/schedule/anticipate
- Implemented operationally by GFO XI.4.A
