# SOURCE TEXT — GFO XII.5.B Unique Invoice Number Requirements

- **Name:** XII.5.B Unique Invoice Number Requirements
- **Date:** REV. 04/02/2015 (page last modified 01/23/2023)
- **Issued by:** New York State Office of the State Comptroller (OSC), Guide to Financial Operations
- **Link (permanent identifier):** https://www.osc.ny.gov/state-agencies/gfo/chapter-xii/xii5b-unique-invoice-number-requirements
...
- The SFS will not automatically prevent the payment of duplicate invoices
- Vendors may not accurately credit Business Units for payments.
- Vendors may not be able to reconcile the invoice numbers and payments on e-Supplier with invoice numbers, payments and accounts in their systems.
- Business Units may have difficulty identifying an overpayment of a single invoice to a vendor.
...
When a vendor submits an electronic invoice with an invoice number that has already been processed by a Business Unit to the vendor in the Accounts Payable module, the electronic invoice is automatically rejected back to the vendor. Business Units should refer to *Section 4.E – Electronic Invoicing Process* of this Chapter, for more information about electronic invoices rejected back to vendors.
...
- GFO XII.6.Z — Processing Payment to Complex Entities (same chapter)
- GFO XII.4.E — Electronic Invoicing Process (same chapter)
