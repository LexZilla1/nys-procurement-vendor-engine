# SOURCE TEXT — GFO XII.6.C Paying Prompt Contract Interest
...
- **Link (permanent identifier):** https://www.osc.ny.gov/state-agencies/gfo/chapter-xii/xii6c-paying-prompt-contract-interest
...
- GFO Chapter XI, Section 4.A — Not-for-Profit Prompt Contracting (determines whether interest is owed)
- GFO Chapter XIV, Section 2 — Obligation, Accounting and Budget Dates
- GFO Chapter XII, Section 5.I — Prompt Payment Interest
- NYS Department of Taxation and Finance interest-rate page: https://www.tax.ny.gov/pay/interest/
- SFS account code 58403 (Prompt Contracting interest)
- Late Contract Interest Worksheet: https://www.osc.ny.gov/files/state-agencies/pdf/xii-6-c-att.pdf
